    ...
    render(){
      ...
      return(
        ...
        <div id="appointment">
          ...
          <div>
          <div className="row">
         <input type="text" placeholder="Doctor Name" name="doc_name" onChange={this.handleChange}/>
         </div>  
         <div className="row">
         <input type="text" placeholder="Enter symptoms" name="symptoms" onChange={this.handleChange}/>
         </div> 
         <div className="row">
         <input type="text" placeholder="Phone number" name="ph_no" onChange={this.handleChange}/>
         </div> 
         <div className="row">
         <input type="text" placeholder="Enter email address" name="email_id" onChange={this.handleChange}/>
         </div> 
         <div className="row">
         <input type="text" placeholder="Enter day" name="day" onChange={this.handleChange}/>
         </div> 
         <div className="row">
         <input type="text" placeholder="Enter timings" name="timings" onChange={this.handleChange}/>
         </div> 
